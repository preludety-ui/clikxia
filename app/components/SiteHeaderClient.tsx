...
export default function SiteHeaderClient({ lang, compact = false }: Props) {
    ...
    <div className={compact ? "site-header site-header-compact" : "site-header"}>
      <style>{`
        ...
        @media (min-width: 768px) {
          .site-header { padding: 72px 32px 40px; }
          .site-header-compact { padding: 36px 32px 24px; }
        }
        ...
        @media (min-width: 768px) {
          .site-header-actions { top: 28px; right: 32px; }
          .site-header-actions-left { top: 28px; left: 32px; }
        }
        ...
        .site-header .site-logo { font-size: 44px; }
      ...
      <Link href="/" className="site-logo">
        <span className="site-logo-clik">CLIK</span>
        <span className="site-logo-xia">XIA</span>
      </Link>
      <div className="site-tagline">{t.tagline}</div>
    </div>
  );
}